(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_5db25aad04612611e536a727")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '5d9162abcec58937cf466fee';
_mrmcp['creative_id'] = '5db25aad04612611e536a727';
...
_mrmcp['height'] = _mrmcp['height'] || 1040;
_mrmcp['type'] = 'smart';
_mrmcp['title'] = '别克·幸福时刻';
_mrmcp['build_number'] = parseInt('295');
_mrmcp['publish_time'] = 'Sat Feb 15 2020 21:17:56 GMT+0800 (CST)';
_mrmcp['last_modified'] = '';
_mrmcp['track_bot'] = 'http://cdn.mugeda.com/media/pages/track/track_20131030.html';
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.2.95';
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        var resPath = jsPath;
            ...
            loadRes(0, resPath + "mugeda_smart_renderer_dateParser" + version + ".js", [0], 2);
        
            loadRes(0, resPath + "mugeda_smart_renderer_chooseimage" + version + ".js", [0], 3);
        
            loadRes(0, resPath + "mugeda_smart_renderer_captureScreen" + version + ".js", [0], 4);
        
        loadRes(0, resPath + "mugeda_utils" + version + ".js", [0]);
        loadRes(1, jsPath + that.crid + ".js?publishTime=1581772676092", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1581772676092" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
